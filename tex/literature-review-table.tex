...
% In-Context learning
        \hline
	\rotatebox{0}{\cite{bocklisch2024task} (Bocklisch, 2024)} & 
        	{\faCheck \quad} & 
...
% InstructTODS
         \hline
	\rotatebox{0}{\cite{chung2023instructtods} (Chung, 2024)} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
...
% DIALIGHT
         \hline
	\rotatebox{0}{\cite{hu2024dialight} (Hu, 2024)} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
...
% DAUS 
         \hline
	\rotatebox{0}{\cite{sekulic2024reliable} (Sekuli, 2024)} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
...
% SynTOD 
         \hline
	\rotatebox{0}{\cite{samarinas2024simulating} (Samarinas, 2024)} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
...
% XDAI
         \hline
	\rotatebox{0}{\cite{yu2022xdai} (Yu, 2022)} & 
        	{\faCheck \quad} & 
		{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} &         	
        	{\textcolor{red}  \faTimes \quad} & 
...
% Prompt-Tuning 
         \hline
	\rotatebox{0}{\cite{kasahara2022building} (Kasahara, 2022)} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
...
% Few-Shot Bot
         \hline
	\rotatebox{0}{\cite{madotto2021few} (Madotto, 2021)} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
...
% RTBF
         \hline
	\rotatebox{0}{\cite{zhang2024right} (Zhang, 2024)} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\faCheck \quad} & 
        	{\faCheck \quad} & 
...
% User Profiling Multilingual Texts
         \hline
	\rotatebox{0}{\cite{nag2023knowledge} (Nag, 2023)} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
...
% User Profiling Recommender
         \hline
	\rotatebox{0}{\cite{peterson2021user} (Peterson, 2021)} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
        	{\textcolor{red}  \faTimes \quad} & 
        	{\faCheck \quad} & 
